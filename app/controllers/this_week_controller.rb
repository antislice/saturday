class ThisWeekController < ApplicationController
  def game
    ...
    @first_game = games.at(games.index{|g| g.game_datetime_local.yday >= Date.today.yday})
    ...
    if @first_game.home_or_away == 'home' and Date.today == @first_game.game_datetime_local
